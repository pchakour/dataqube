...
```
  ...
  desc "Target to write the date object. By default, the date object will be use as default event date by storing it in the timestamp field"
  config_param :target, :string, default: 'timestamp'
  desc """
...
"""
  ...
  desc "Severity if the plugin assert an error"
